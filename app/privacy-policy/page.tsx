    ...
    <div className="px-6 py-12">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-4 text-muted leading-relaxed">
          ...
          <p>We use cookies only for essential functionality and user preferences. When you first visit ColorCraft, you will see a cookie consent banner. If you accept, we store your preference in a cookie so the banner does not appear again on future visits. This cookie contains no personal data and is not used for tracking or advertising purposes.</p>
          <p>You can change or withdraw your cookie consent at any time by clearing your browser cookies for colorcraft.vercel.app.</p>
